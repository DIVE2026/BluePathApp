...
public class PromotionRulesTest {
    ...
    @Test
    public void tiersUseConsistentEmojiAndOrder() {
        assertEquals("🥉 브론즈", PromotionRules.displayName("브론즈"));
        assertEquals("💎 다이아", PromotionRules.displayName("다이아"));
        assertEquals("다이아", PromotionRules.nextTier("플래티넘"));
        assertTrue(PromotionRules.rank("다이아") > PromotionRules.rank("플래티넘"));
    }

    @Test
    public void manualIncludesDelayedGradingAndDiamondEvidence() {
